...
public final class EmployeeScripts {
    ...
    public static final String UPDATE = "UPDATE EMPLOYEE SET USERNAME = :username, FIRST_NAME = :firstName, LAST_NAME = :lastName, EMAIL = :email, GENDER = :gender  WHERE ID = :id";
    ...
    public static final String FIND_BY_ID = "SELECT ID, USERNAME, PASSWORD, FIRST_NAME, LAST_NAME, EMAIL, BIRTHDAY, START_WORKING_DATE,ROLE ,GENDER,CREATOR,CREATION_TIME " +
